...
// Room definitions — one unified space, two halves separated by a thin line
export const ROOMS = {
  workspace: {
    x: 0.02, y: 0.03, w: 0.57, h: 0.94,
    label: 'WORKSPACE', bg: 'rgba(12,14,35,0.6)', border: '#3344aa',
    accent: '#4a6aff', icon: '💻',
  },
  cabin: {
    x: 0.59, y: 0.03, w: 0.39, h: 0.94,
...
export const UNIFIED_BOX = { x: 0.02, y: 0.03, w: 0.96, h: 0.94, dividerX: 0.59 };
